      ...
      <section>
        ...
        <div className="row">
          <div className="column2">
            <p>Shipping typically takes 3-5 business days. Estimated number of business days it takes 
          ...
          <div className="column2">
            <img src="cs-316-project-beso-solutions/app/images/IMG_6339.jpg"></img>
          </div>
        </div>
      </section>
